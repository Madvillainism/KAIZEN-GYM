...
<body>
    ...
    <div class="row my-5 mx-auto w-75 align-items-center">
        <h2 class="h1 fw-bold text-center"><i class="bi bi-person-plus-fill me-2"></i></i>REGISTRATE</h2>
        <div class="col-12 col-lg-6 p-3">
            <img src="./src/img/vertical2.jpg" class="img-fluid h-50">
        </div>
        <div class="col-12 col-lg-6 p-3 text-center text-lg-start">
            ...
            <label for="name" class="form-label mt-2 fs-5"><i class="bi bi-postcard me-1"></i>Cedula</label>
                <input type="text" id="cel" class="form-control" name="cedulaR" placeholder="Ingrese la cedula">

            <div class="row">

            <div class="col-6">
                <label for="name" class="form-label mt-2 fs-5"><i class="bi bi-person-check me-1"></i>Nombre</label>
                <input type="text" id="name" class="form-control" name="nombreR" placeholder="Ingrese el Nombre">
                </div>

                <div class="col-6">
                <label for="name" class="form-label mt-2 fs-5"><i class="bi bi-person-check-fill me-1"></i>Apellido</label>
                <input type="text" id="lname" class="form-control" name="apellidoR" placeholder="Ingrese el Apellido">
                </div>
            ...
            <div class="row">
                ...
                <div class="col-3">
                <input type="text" id="tlf1" class="form-control" name="tele1R" placeholder="XXXX">
                 </div>

                <div class="col-9">
                <input type="text" id="tlf2" class="form-control" name="tele2R" placeholder="XXXXXXX">
                </div>

                </div>


                <label for="email" class="form-label mt-2 fs-5"><i class="bi bi-mailbox me-2"></i>Dirección</label>
                <input type="email" id="direccion" class="form-control" name="direccionR" placeholder="Ingrese el correo electronico">

                <label for="email" class="form-label mt-2 fs-5"><i class="bi bi-envelope me-2"></i>Correo</label>
                <input type="email" id="email" class="form-control" name="correoR" placeholder="Ingrese el correo electronico">
                ...
                <select name="entreR" class="form-control" id="membresia" onchange="habilitarCombo(this.value);">
            ...
            <div class="row text-center text-lg-start">
                ...
                <p class="m-0"><a href="./register.html" class="link">¡Registro casi completado!</a></p>
            </div>
        </div>
    </div> 
