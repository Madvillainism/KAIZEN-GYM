    ...
    <div class="row my-5 mx-auto w-75 align-items-center">
        ...
        <div class="col-12 col-lg-6 p-3 text-center text-lg-start">
            <form action="" method="POST">
                <label for="name" class="form-label mt-2 fs-5"><i class="bi bi-person-fill me-1"></i>Cedula</label>
                <input type="text" id="name" class="form-control" name="cedulaR" placeholder="Ingrese la cedula">
