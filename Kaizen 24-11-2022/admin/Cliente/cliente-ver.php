...
$query2= "SELECT nombre FROM membresia";
...
<body>
  ...
  <nav class="sidebar">
    <hr>
    <a href="admin-cliente.php" class="button-main"><i class="bi bi-people-fill mx-2"></i>Clientes</a>
    <a href="../../admin/Trainer/admin-trainer.php" class="button"><i class="bi bi-person-square mx-2"></i>Entrenador</a>
  ...
  <div class="container app">
    <div class="row px-4 py-3">
      <h1 class="h1 text-center my-2"><i class="bi bi-people-fill mx-2"></i>Información Cliente</h1>
      <div class="col-12 p-2">
        <div class="row Info-container">
          ...
          <div class="col-7 info">
            ...
            <div class="section">
              <h5><b><i class="bi bi-person-check me-2"></i>
                  Nombre: </b><?php echo $row['nombre']; ?> <?php echo $row['apellido']; ?>
              </h5>
            </div>
            <div class="section">
              <h5><b><i class="bi bi-postcard me-2"></i>
                  Cédula: </b><?php echo $row['cedula']; ?>
              </h5>
            </div>
            <div class="section">
              <h5><b><i class="bi bi-cash-coin me-2">
                  </i>Saldo: </b><?php echo $row['saldo']; ?>
              </h5>
            </div>
            <div class="section">
              <h5><b><i class="bi bi-phone-vibrate me-2"></i>
                  Teléfono: </b><?php echo $row['telefono']; ?>
              </h5>
            </div>
            <div class="section">
              <h5><b><i class="bi bi-mailbox me-2">
                  </i>Dirección: </b><?php echo $row['direccion']; ?>
              </h5>
            </div>
            <div class="section">
        ...
        <div class="container-button">
          <a href="./admin-cliente.php" class="btn btn-primary my-1 w-25">Volver</a>
        </div>
      </div>
    </div>
  </div>
