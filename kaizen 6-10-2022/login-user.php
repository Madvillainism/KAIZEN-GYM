...
<body>
    ...
    <div class="container w-75">
        ...
        <h2 class="h1 fw-bold text-center"><i class="bi bi-person-fill me-2"></i>INICIAR SESION</h2>
            <h3 class="h2 fw-bold text-center orange">CLIENTE</h3>
            <div class="col-12 col-lg-6 p-3">
                <img src="./src/img/vertical1.jpg" class="img">
            </div>
            <div class="col-12 col-lg-6 p-3 text-center text-lg-start">
                ...
                <div class="row text-center text-lg-start">
                    ...
                    <p class="m-0">Comunicate con un administrador para registrarte</p>
                </div>
            </div>
        </div>
    </div>
