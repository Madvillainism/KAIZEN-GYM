...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark p-2 p-lg-0">
        <div class="container-fluid">
          <a class="navbar-brand px-2 logo" href="#"><img src="./src/img/kaizen.png" style="width: 100px"></a>
          ...
          <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
              ...
              <a class="nav-link px-3 my-1 my-lg-0 mx-1 btn btn-outline-primary" href="./register.html"><i class="bi bi-person-plus-fill me-1"></i>Registrarse</a>
            </div>
          </div>
        </div>
    </nav>
    <div class="row my-5 mx-auto w-75 align-items-center">
        ...
        <div class="col-12 col-lg-6 p-3">
            <img src="./src/img/vertical1.jpg" class="img-fluid h-50">
        </div>
        <div class="col-12 col-lg-6 p-3 text-center text-lg-start">
            <form action="" method="POST">
                ...
                <input type="email" id="email" class="form-control" placeholder="Ingrese su correo electronico">
                ...
                <input type="submit" name="" id="" class="btn btn-primary my-3 w-100" value="Ingresar">
            </form>
            <div></div>
