        ...
        <div class="row Edit-container">
          ...
          <input type="hidden" name="type" value="modif"/>
            <label` for="name" class="form-label mt-2 fs-5"><i class="bi bi-postcard me-1"></i>Cedula</label>
              ...
              <input required type="text" id="direccion" class="form-control" name="direccionR" value="<?php echo $row['direccion']; ?>" placeholder="Ingrese el correo electronico">
              <label for="email" class="form-label mt-2 fs-5"><i class="bi bi-envelope me-2"></i>Correo</label>
              <input required type="email" id="email" class="form-control" name="correoR" value="<?php echo $row['correo']; ?>"placeholder="Ingrese el correo electronico">
              <div class="row">
                <div class="col-6">
