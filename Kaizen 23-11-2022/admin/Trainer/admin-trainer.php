...
$query = "SELECT idEntrenador, nombre, cedula FROM entrenador";
...
<body>
  ...
  <nav class="sidebar">
    ...
    <a href="../Trainer/admin-trainer.php" class="button-main"><i class="bi bi-person-square mx-2"></i>Entrenador</a>
  ...
  <div class="container app">
    <div class="row px-4 py-3">
      <h1 class="h1 text-center mb-3"><i class="bi bi-people-fill mx-2"></i>Entrenadores</h1>
      <div clas="col-4">
        <h4 class="text-center">Total Entrenadores:
          <?php echo $filas ?>
        </h4>
      </div>
    </div>
    <div class="row px-4 py-3">
      ...
      <div class="col-2 px-2 align-v">
        <button class="btn btn-primary my-1 w-100" data-bs-toggle="modal" data-bs-target="#add"><i
            class="bi bi-person-plus-fill me-2"></i>Agregar</button>
        <button class="btn btn-primary my-1 w-100" data-bs-toggle="modal" data-bs-target="#delete"><i
            class="bi bi-person-dash-fill me-2"></i>Eliminar</button>
              ...
              <div class="row">
                <div class="col-6">
                  ...
                  <div class="col-12 d-flex">
                    <input required id="tlf1" class="form-control" name="SueldoR" placeholder="XXXX" type="number"
  ...
  <div class="modal fade" id="delete" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title h3"><i class="bi bi-person-dash-fill mx-2"></i>Eliminar Entrenador</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          ¿Desea eliminar el entrenador?
        </div>
        <div class="modal-footer">
