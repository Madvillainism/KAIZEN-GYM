...
<body>
  ...
  <nav class="sidebar">
    ...
    <a href="../Trainer/admin-trainer.html" class="button"><i class="bi bi-person-square mx-2"></i>Entrenador</a>
    <a href="../Componentes/admin-componentes.html" class="button"><i class="bi bi-box mx-2"></i>Componentes</a>
